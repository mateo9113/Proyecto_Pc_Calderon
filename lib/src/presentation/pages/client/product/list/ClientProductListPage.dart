...
import 'package:app_proyecto_pccalderon/src/presentation/pages/client/product/list/ClientProductListItem.dart';
import 'package:app_proyecto_pccalderon/src/presentation/pages/client/product/list/bloc/ClientProductListBloc.dart';
import 'package:app_proyecto_pccalderon/src/presentation/pages/client/product/list/bloc/ClientProductListEvent.dart';
import 'package:app_proyecto_pccalderon/src/presentation/pages/client/product/list/bloc/ClientProductListState.dart';
...
class _ClientProductListPageState extends State<ClientProductListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: BlocListener<ClientProductListBloc, ClientProductListState>(listener: (context, state) {
