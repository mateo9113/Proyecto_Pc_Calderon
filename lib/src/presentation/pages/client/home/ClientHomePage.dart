...
import 'package:app_proyecto_pccalderon/src/presentation/pages/client/category/list/ClientCategoryListPage.dart';
...
class _ClientHomePageState extends State<ClientHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        drawer: BlocBuilder<ClientHomeBloc, ClientHomeState>(builder: (context, state) {
          return Drawer(
            child: ListView(
        ...
        body: BlocBuilder<ClientHomeBloc, ClientHomeState>(builder: (context, state) {
