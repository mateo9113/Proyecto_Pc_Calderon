...
class ClientShoppingBagItem extends StatelessWidget {
  ...
  ClientShoppingBagItem(this.bloc, this.state, this.product, {super.key});
      ...
      child: Row(
        children: [
          ...
          Column(
              ...
              children: [_textProduct(), SizedBox(height: 5), _actionsAddAndSubtract()]),
          Spacer(),
          Column(
  ...
  Widget _textPrice() {
    return product != null
        ? Text(
            '\Bs. ${product!.precio * product!.quantity!}',
  ...
  Widget _textProduct() {
    return SizedBox(
      width: 170,
      child: Text(
        product?.nombre ?? 'Titulo del producto',
