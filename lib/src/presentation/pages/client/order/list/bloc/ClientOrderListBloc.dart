...
import 'package:app_proyecto_pccalderon/src/domain/useCases/orders/OrdersUseCases.dart';
...
class ClientOrderListBloc extends Bloc<ClientOrderListEvent, ClientOrderListState> {
  ...
  Future<void> _onGetOrders(GetOrders event, Emitter<ClientOrderListState> emit) async {
    ...
    Resource response = await ordersUseCases.getOrdersByClient.run(authResponse.usuario.id!);
